    ...
    <div class="content-page">
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-xl-12">
               <a href="{{route('admin.area3')}}" class="btn" style="background-color:#034ea2;color:white;">
                  <i class="mdi mdi-arrow-left"></i>
                  prev
               </a><br><br>
               <div class="card-box">
                  <h4 class="header-title mt-0 m-b-30">Area 3 - Models</h4>
                             ...
                             <div class="modal fade" id="updateForm{{$model->id}}">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <form action="{{route('admin.update_model_name.area3')}}" method="POST">
                                    @csrf
