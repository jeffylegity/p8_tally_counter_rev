...
@foreach ($plan as $data)
   <div class="col-lg-2" style="margin-left:8%;">
      <center>
         ...
         <h1 style="font-size:500%"><b>{{$data->sl166_target}}</b></h1>
         <h4><b>SL-166</b></h4>
      </center>
   </div>
   <div class="col-lg-2">
      <center>
         ...
         <h1 style="font-size:500%"><b>{{$data->sl167_target}}</b></h1>
         <h4><b>SL-167</b></h4>
      </center>
   </div>
   <div class="col-lg-2">
      <center>
         ...
         <h1 style="font-size:500%"><b>{{$data->sl168_target}}</b></h1>
         <h4><b>SL-168</b></h4>
      </center>
   </div>  
   <div class="col-lg-2">
      <center>
         ...
         <h1 style="font-size:500%"><b>{{$data->sl169_target}}</b></h1>
         <h4><b>SL-169</b></h4>
      </center>
   </div> 
   <div class="col-lg-2">
      <center>
         ...
         <h1 style="font-size:500%"><b>{{$data->sl170_target}}</b></h1>
         <h4><b>SL-170</b></h4>
      </center>
   </div> 
@endforeach
