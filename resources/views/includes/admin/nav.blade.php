     ...
     <div class="left side-menu">
       <div class="sidebar-inner slimscrollleft">
          <div id="sidebar-menu">
             <ul>
                <li>
                   <a href="#" class="waves-effect" ><i class="mdi mdi-comment-alert-outline"></i> <span> Pending for Approval </span> </a>
                </li>
                <li>
                   <a href="#" class="waves-effect" ><i class="mdi mdi-account-alert"></i> <span> Pending Request(s)</span> </a>
                </li>
                <li class="has_sub">
                   <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-float-none"></i><span>Request Form</span></a>
                   <ul class="list-unstyled">
                      <li><a href="#">Equipment Engineering</a></li>
